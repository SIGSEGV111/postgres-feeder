...
postgres-feeder: postgres-feeder.cpp Makefile
	g++ -fwhole-program -Wall -Wextra -flto -O3 -march=native -fdata-sections -ffunction-sections -Wl,--gc-sections postgres-feeder.cpp -l pq -o postgres-feeder -Wno-unused-variable
